...
def averagerating(value, args):
	...
	if temp == 1:
		temp1 = "<span class='fa fa-star text-secondary'></span> <span class='fa fa-star text-secondary'></span> <span class='fa fa-star text-secondary'></span> <span class='fa fa-star text-secondary'></span> <span class='fa fa-star text-secondary'></span>"
	elif temp == 2:
		temp1 = "<span class='fa fa-star text-secondary'></span> <span class='fa fa-star text-secondary'></span> <span class='fa fa-star text-secondary'></span> <span class='fa fa-star text-secondary'></span> <span class='fa fa-star text-secondary'></span>"
	elif temp == 3:
